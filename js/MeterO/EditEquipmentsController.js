...
$scope.clearall=function()
{
    ...
    var clearURL="http://10.10.10.75:60000/api/metero/ClearAllNotes";
...
$rootScope.$on('editEquiptabchanged', function (event, args) {
        ...
        var getEquipmentssurl='http://10.10.10.75:60000/api/metero/getequipments';
...
$rootScope.update=function(row)
{
    ...
    var jsonObject=[];
    jsonObject.push(row);
    var postScheduleUrl="http://10.10.10.75:60000/api/metero/updateEquipment";
...
{
   // alert(row.Equipment);
    var mailtoURL="http://10.10.10.75:60000/api/metero/sendEmailQuery";
    var jsonObject=[];
    $.confirm({
    title: 'Submit Query',
    columnClass:'large',
