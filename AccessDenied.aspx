...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container" style="height:30%;">
     ...
     <div class="alert alert-danger" role="alert">
            ...
            <strong><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>Warning!</strong> Unauthorized access. Kindly Login first, click on the login link below.
            <br/>
            <strong><a href="IEA_AppLogin.aspx">Click here to Login</a></strong>
      </div>
